 ...
 */
public enum Card {
	GREEN(Type.PERSON), MUSTARD(Type.PERSON), PEACOCK(Type.PERSON), PLUM(Type.PERSON), SCARLET(Type.PERSON), WHITE(Type.PERSON),

    WRENCH(Type.WEAPON), CANDLESTICK(Type.WEAPON), DAGGER(Type.WEAPON), PISTOL(Type.WEAPON), LEAD_PIPE(Type.WEAPON), ROPE(Type.WEAPON),

    BATHROOM(Type.LOCATION), OFFICE(Type.LOCATION), DINING_ROOM(Type.LOCATION), GAME_ROOM(Type.LOCATION), GARAGE(Type.LOCATION), BEDROOM(Type.LOCATION),
	LIVING_ROOM(Type.LOCATION), KITCHEN(Type.LOCATION), COURTYARD(Type.LOCATION);
